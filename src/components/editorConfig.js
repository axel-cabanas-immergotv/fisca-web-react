...
function validateEditorDependencies() {
    ...
    const requiredClasses = [
        { name: 'EditorJS', class: typeof EditorJS !== 'undefined' ? EditorJS : undefined },
        { name: 'Header', class: typeof Header !== 'undefined' ? Header : undefined },
        { name: 'Paragraph', class: typeof Paragraph !== 'undefined' ? Paragraph : undefined },
        { name: 'List', class: typeof List !== 'undefined' ? List : undefined },
        { name: 'Quote', class: typeof Quote !== 'undefined' ? Quote : undefined },
        { name: 'Table', class: typeof Table !== 'undefined' ? Table : undefined },
        { name: 'Delimiter', class: typeof Delimiter !== 'undefined' ? Delimiter : undefined },
        { name: 'ImageTool', class: typeof ImageTool !== 'undefined' ? ImageTool : undefined },
        { name: 'TextAlign', class: typeof TextAlign !== 'undefined' ? TextAlign : undefined },
        { name: 'ColumnsBlock', class: typeof ColumnsBlock !== 'undefined' ? ColumnsBlock : undefined },
        { name: 'AdvUnitBlock', class: typeof AdvUnitBlock !== 'undefined' ? AdvUnitBlock : undefined }
    ];
